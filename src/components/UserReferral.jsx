...
//   // Try primary endpoint for users with referrals
//   let response = await fetch(`${API_URL}/api/admin/users`, {
//     headers: {
...
//   // Fallback to a different endpoint if /users fails (adjust based on your API)
//   if (!response.ok && response.status === 404) {
//     console.warn('Users endpoint not found, falling back to alternative endpoint');
//     response = await fetch(`${API_URL}/api/admin/referrals`, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//         'Content-Type': 'application/json',
//       },
...
//   // Ensure username is included and referrals are properly formatted
...
// // Vanilla CSS styles (aligned with Deposits component)
// const styles = `
//   .main-content {
//     max-width: 1200px;
//     margin: 0 auto;
...
//       setNotification({
//         type: 'error',
//         message: err.message || 'Failed to load users. Please check the API endpoint or contact support.',
//       });
//     },
